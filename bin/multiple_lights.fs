...
vec4 CalcDirLight(DirLight light, vec3 normal, vec3 viewDir)
{
    ...
    // combine results
    vec4 ambient = vec4(light.ambient, 1) * vec4(texture(diffuse_texture, vs_out.TexCoords));
    vec4 diffuse = vec4(light.diffuse, 1) * diff * vec4(texture(diffuse_texture, vs_out.TexCoords));            // ================================================================================================
    vec4 specular = vec4(light.specular, 1) * spec * vec4(texture(material.specular, vs_out.TexCoords)); // ================================================================================================
