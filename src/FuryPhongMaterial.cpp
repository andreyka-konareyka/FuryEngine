...
FuryPhongMaterial::FuryPhongMaterial() :
    FuryPhongMaterial(glm::vec3(1, 1, 1),
                 glm::vec3(1, 1, 1))
{

}

FuryPhongMaterial::FuryPhongMaterial(const glm::vec3 &_diffuseColor,
...
QJsonObject FuryPhongMaterial::toJson() const
{
    QJsonObject result;
    result["materialType"] = "FuryPhongMaterial";
...
FuryPhongMaterial *FuryPhongMaterial::fromJson(const QJsonObject &_object)
{
    FuryPhongMaterial* result = new FuryPhongMaterial;
...
FuryPhongMaterial *FuryPhongMaterial::createFromAssimp(const aiMaterial *_assimpMaterial,
                                                       const QString &_path)
{
    FuryPhongMaterial* result = new FuryPhongMaterial;
