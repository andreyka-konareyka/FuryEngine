...
public:
    ...
    // constructor
    Mesh(QVector<Vertex> vertices, QVector<unsigned int> indices, QVector<raw_Texture>& textures)
    {
    ...
    void Draw(Shader& shader)
    {
        ...
        for (unsigned int i = 0; i < textures.size(); i++)
        {
            ...
            glUniform1i(glGetUniformLocation(shader.Program, qUtf8Printable(name + number)), i);
