...
SphereObject::SphereObject() : SphereObject(glm::vec3(0, 0, 0)) {}
SphereObject::SphereObject(const glm::vec3& _position) : SphereObject(_position, 1) {}
SphereObject::SphereObject(const glm::vec3& _position, double _size) :
    Object(_position)
{
    setSizes(glm::vec3(_size, _size, _size));
...
void SphereObject::Tick(double /*_dt*/)
{
    if (physicsEnabled())
    {
...
void SphereObject::Setup_physics(reactphysics3d::PhysicsCommon& _physCommon, reactphysics3d::PhysicsWorld* _physWorld, reactphysics3d::BodyType _type)
{
    ...
    reactphysics3d::SphereShape* sphereShape = _physCommon.createSphereShape(sizes().x);
