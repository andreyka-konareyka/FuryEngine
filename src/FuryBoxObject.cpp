...
FuryBoxObject::FuryBoxObject() : FuryBoxObject(1) { }
FuryBoxObject::FuryBoxObject(double _scale) : FuryBoxObject(_scale, _scale, _scale) {}
FuryBoxObject::FuryBoxObject(double _scaleX, double _scaleY, double _scaleZ) : FuryBoxObject(glm::vec3(0, 0, 0), _scaleX, _scaleY, _scaleZ) {}
FuryBoxObject::FuryBoxObject(const glm::vec3& _position) : FuryBoxObject(_position, 1) {}
FuryBoxObject::FuryBoxObject(const glm::vec3& _position, double _scale) : FuryBoxObject(_position, _scale, _scale, _scale) {}
FuryBoxObject::FuryBoxObject(const glm::vec3& _position, double _scaleX, double _scaleY, double _scaleZ) : FuryBoxObject(_position, glm::vec3(_scaleX, _scaleY, _scaleZ), glm::vec3(0, 0, 0)) {}


FuryBoxObject::FuryBoxObject(const glm::vec3& _position, const glm::vec3& _scales, const glm::vec3& _rotate) :
...
void FuryBoxObject::Setup_physics(reactphysics3d::PhysicsCommon& _physCommon, reactphysics3d::PhysicsWorld* _physWorld, reactphysics3d::BodyType _type)
{
...
void FuryBoxObject::draw(Camera* _camera, int _windowWidth, int _windowHeight, glm::vec3& _dirlight, glm::mat4& _lightSpaceMatrix, GLuint _depthMap) {
...
//    shader()->setFloat("pointLights[3].quadratic", 0.032f);
    ...
    model = glm::scale(model, scales());	// it's a bit too big for our scene, so scale it down
